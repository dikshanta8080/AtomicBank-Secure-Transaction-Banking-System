...
<div class="left-panel">
    <div>
        ...
        <h1 class="brand-headline">
            Welcome<br>back to<br><em>Atomic.</em>
        </h1>
        <p class="brand-sub">
            Your finances are safe with us.
            Sign in to access your accounts, transfers, and more.
        </p>
    </div>
    ...
    <div class="features">
        <div class="feature-item">
            ...
            <span class="feature-text">Secure two-factor authentication available</span>
        </div>
        <div class="feature-item">
            <div class="feature-icon">
                <svg viewBox="0 0 24 24">
...
<div class="right-panel">
    <div class="form-container">
        ...
        <p class="footer-note">
            Protected by Atomic Bank security. &copy; 2025 Atomic Bank. All rights reserved.
        </p>
