...
<div class="left-panel">
    <div>
        ...
        <p class="brand-sub">Your finances, secured and always within reach. Sign in to access your accounts, transfers,
            and more.</p>
    </div>
    <div class="features">
        ...
        <div class="feature-item">
            ...
            <span class="feature-text">All the operations are wrapped in Transaction</span>
        </div>
        <div class="feature-item">
            <div class="feature-icon">
                <svg viewBox="0 0 24 24">
            ...
            <span class="feature-text">Secure transactions with Row Level Locking</span>
        </div>
    </div>
</div>
...
<div class="right-panel">
    <div class="form-container">
        ...
        <p class="form-subtitle">Don't have an account? <a href="<%= request.getContextPath() %>/register">Create one
            free</a></p>

        <% if (request.getAttribute("error") != null) { %>
        <div class="alert alert-error"><%= request.getAttribute("error") %>
        </div>
        <% } %>
